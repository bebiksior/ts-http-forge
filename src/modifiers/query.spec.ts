...
describe("setQuery", () => {
  describe("valid input", () => {
    ...
    it("should replace existing query string", () => {
      const lines: HTTPRequestLines = ["GET /api/users?old=param HTTP/1.1"];
    ...
    it("should remove query string when empty", () => {
      const lines: HTTPRequestLines = ["GET /api/users?param=value HTTP/1.1"];
    ...
    it("should handle request without HTTP version", () => {
      const lines: HTTPRequestLines = ["GET /api/users"];
  ...
  describe("edge cases", () => {
    it("should throw error when input is empty", () => {
      ...
      expect(() => setQuery(lines, "param=value")).toThrow(
    ...
    it("should throw error when query is null", () => {
      ...
      expect(() => setQuery(lines, null as any)).toThrow(
    ...
    it("should throw error when query is undefined", () => {
      ...
      expect(() => setQuery(lines, undefined as any)).toThrow(
        "Query cannot be null or undefined"
      );
    });
  });
...
describe("addQueryParam", () => {
  describe("valid input", () => {
    ...
    it("should add parameter to existing query string", () => {
      ...
      expect(result[0]).toBe(
        "GET /api/users?existing=param&new=value HTTP/1.1"
      );
    });
    ...
    it("should handle special characters in values", () => {
      ...
      expect(result[0]).toBe(
        "GET /api/users?query=hello%20%26%20world HTTP/1.1"
      );
    });
  ...
  describe("edge cases", () => {
    it("should throw error when input is empty", () => {
      ...
      expect(() => addQueryParam(lines, "key", "value")).toThrow(
        "Request cannot be empty"
      );
    });
    ...
    it("should throw error when key is empty", () => {
      ...
      expect(() => addQueryParam(lines, "", "value")).toThrow(
...
describe("removeQueryParam", () => {
  describe("valid input", () => {
    ...
    it("should remove last parameter and question mark", () => {
      const lines: HTTPRequestLines = ["GET /api/users?name=john HTTP/1.1"];
    ...
    it("should remove parameter from middle of query", () => {
      const lines: HTTPRequestLines = ["GET /api/users?a=1&b=2&c=3 HTTP/1.1"];
    ...
    it("should handle request without HTTP version", () => {
      const lines: HTTPRequestLines = ["GET /api/users?name=john"];
  ...
  describe("edge cases", () => {
    it("should throw error when input is empty", () => {
      ...
      expect(() => removeQueryParam(lines, "key")).toThrow(
        "Request cannot be empty"
      );
    });
    ...
    it("should throw error when key is empty", () => {
      ...
      expect(() => removeQueryParam(lines, "")).toThrow(
        "Query parameter key cannot be empty"
      );
    });
  ...
  describe("malformed input preservation", () => {
    ...
    it("should handle parameters without values", () => {
      const lines: HTTPRequestLines = ["GET /path?flag&name=john HTTP/1.1"];
  ...
  describe("array immutability", () => {
    it("should not mutate original lines array", () => {
      const lines: HTTPRequestLines = ["GET /path?key=value HTTP/1.1"];
      const originalLines = [...lines];
